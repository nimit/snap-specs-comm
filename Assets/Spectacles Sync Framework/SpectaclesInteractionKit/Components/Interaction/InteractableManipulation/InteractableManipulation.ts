...
export class InteractableManipulation extends BaseScriptComponent {
  ...
  // TODO(LAF-4374): Set isManipulatable to true
  ...
  /**
   * TODO (LAF-2849) These should be replaced with the OneEuroFilter in HandTracking
  ...
  private onTriggerToggle(eventData: InteractorEvent): void {
    ...
    // TODO (LAF-2723) This will make it so only two interactors max can interact on an interactable
  ...
  private singleInteractorTransform(interactor: Interactor): void {
    ...
    if (this.canRotate()) {
      ...
      // TODO (LAF-3785) Clarify exactly how we want to handle single indirect rotation case (atm we do no rotation)
    }
  }
