...
/*
 * Sphere cast sizes from https://github.sc-corp.net/vhwang/input-dev/blob/main/Assets/InputSystem/Scripts/Targeting/TargetProvider.cs
 * Default sphere cast sizes were then halved as proposed by LabUX: https://jira.sc-corp.net/browse/LAF-3812
 */
