...
type RadialOcclusionViewConfig = {
  handType: HandType
...
export default class RadialOcclusionView {
  ...
  constructor(private config: RadialOcclusionViewConfig) {
    this.updateDispatcher
      ...
      .bind(() => {
        /**
         * Disable gradient quad when in capture mode. Related to this JIRA ticket: https://jira.sc-corp.net/browse/LAF-5341
         *
         ...
         *
         * For reference on the capture implementation see:
         * https://docs.google.com/document/d/1NT_yadoaSFqWvVkeMCb2qs3Um4pTLfbnW9_ySubsBbw/edit#heading=h.qx01nbuap9ai
         * https://docs.google.com/document/d/1ETmZGpOyKIjGfDs0uFimK0MB_ZXeI2AMW3XWeEm8L_g/edit#heading=h.kea08t5mwsr3
         *
         * This code is a "trick" fix, and will break if the capture implementation changes.
         * TODO (LAF-5502) Ideally we will change the way which "hand radial occlusion" works so that we don't need to switch
         * logic between capture and non-capture modes.
         */
