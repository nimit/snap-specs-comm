        ...
        this.onTriggerRelease = (e) => {
            ...
            if (this.isActive && !this.isScaling && this.isEnabled) {
                ...
                if (this.itemSnappingRange &&
                    ...
                    let startPosition = ((_c = this.parentTransform) === null || _c === void 0 ? void 0 : _c.getLocalPosition()) || vec3.zero();
                    (0, animate_1.default)({
                    ...
                    let startRot = ((_d = this.parentTransform) === null || _d === void 0 ? void 0 : _d.getWorldRotation()) || quat.quatIdentity();
                    ...
                    let startRot = this.parentTransform.getWorldRotation();
                    let endRot = this.colliderRotation;
                    (0, animate_1.default)({
                        cancelSet: this.animationCancelSet,
                        duration: 0.14,
                        start: 0,
