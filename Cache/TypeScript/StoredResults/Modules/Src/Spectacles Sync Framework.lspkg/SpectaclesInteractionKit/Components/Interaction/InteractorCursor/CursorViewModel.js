...
class CursorViewModel {
    constructor(enableCursorSnapping, enableFilter, _interactor) {
        ...
        /**
         * TODO(LAF-3147) - Review filtering/smoothing used for cursor with design as the strategy for this will differ from the line cursor.
    ...
    setupStateMachine() {
        ...
        this.stateMachine.addState({
            ...
            onUpdate: () => {
                /**
                 * TODO(LAF-3469): Revise manipulate visuals
    ...
    checkPlanecastWithinScrollView() {
        var _a, _b;
        return ((_b = (_a = this.scrollView) === null || _a === void 0 ? void 0 : _a.getSceneObject().getComponent("Component.ScreenTransform").containsWorldPoint(this.getPlanecastCursorPosition())) !== null && _b !== void 0 ? _b : false);
    }
    /**
