...
// TODO (https://jira.sc-corp.net/browse/HSW-4278): Unify this with other animation
// approaches throughout the repo
export default function animate(config: AnimateConfig): CancelFunction {
  ...
  // HACK: using delay frames like this is a workaround for this issue:
  // https://jira.sc-corp.net/browse/LOOK-81117
  // kick off the first frame of the animation
