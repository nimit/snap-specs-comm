...
export class HandInteractor extends BaseInteractor {
  ...
  /*
   * TODO(LAF-3355) - Remove setInputEnabled when it will be done internally by IFS
   * If this method is called, we need to disable all hands even if this HandInteractor
   * is specifically for the right hand. This is because this request comes from InteractionManager
   * and means another input type has been detected (most likely mobile controller)
   */
  /** @inheritdoc */
