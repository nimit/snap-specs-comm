...
//}
//ubo int UserUniforms 2:24:4016 {
...
//float lineWeight 3924
//float4 lineColor 3936
//float Port_Input1_N016 3952
//float Port_Input1_N013 3956
//float Port_Input1_N017 3960
//float4 Port_Value1_N015 3968
//float Port_Input1_N024 3984
//float4 Port_Value1_N022 4000
//}
...
{
float l9_181=2.0/log2((*sc_set2.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_180.z=((log2(fast::max((*sc_set2.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_180.w))*l9_181)-1.0)*l9_180.w;
}
float4 l9_182=l9_180;
l9_169=l9_182;
float4 l9_183=l9_169;
...
{
float l9_186=dot(l9_185,(*sc_set2.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_187=l9_186;
...
{
out.varClipDistance=l9_187;
}
}
float4 l9_188=float4(l9_184.x,-l9_184.y,(l9_184.z*0.5)+(l9_184.w*0.5),l9_184.w);
out.gl_Position=l9_188;
v=param_17;
